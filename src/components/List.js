...
import { Button, Card, Col, Container, Form, Image, Navbar, Row } from 'react-bootstrap';
                ...
                <Navbar>
                    ...
                    <Navbar.Collapse className="justify-content-end ">
                        <Navbar.Text className='text-warning fw-semibold'>
                            Hello , I am Pikachu
                            <img id="rotate-image" src='https://cdn-icons-png.flaticon.com/512/188/188987.png' width={40} />
                        </Navbar.Text>
                    </Navbar.Collapse>
                </Navbar>
                                ...
                                return (
                                    <Col className='mt-4 mb-3' key={i} >
                                        <Card className='text-light position-relative text-center bgCard' style={{ background: "#0c519c" }}>
                                            ...
                                            <Card.Footer className='border-0 text-center'>
                                                <Button className='btn btn-warning w-100' onClick={() => getDetail(element.url)}>Open Detail</Button>
                                            </Card.Footer>
                                        </Card>
                                    </Col>
                                )
