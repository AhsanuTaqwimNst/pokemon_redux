    ...
    <div>
      ...
      >
        <FontAwesomeIcon icon={faArrowLeft} /> Back
            ...
            <Card
              className="w-75 mt-1 animated flip"
              style={{
                background: "none",
                margin: "auto",
                position: "relative",
            ...
            >            
            <Card
              className="justify-content-center mx-auto mt-3 border-0 bg-secondary d-flex"
              style={{ width: "90%" }}
            >
              ...
              >
                <Row className="d-flex align-items-center">
                  <Col>
                    <Card.Title className="text-capitalize fs-3 bg-primary text-center p-2 rounded-5">
                      {pokemon?.data?.name}
                    </Card.Title>
                  </Col>
                  <Col className="d-flex">
                    ...
                    {pokemon?.data?.abilities?.map((element) => (
                      <Card.Title className="text-capitalize fs-6 text-warning">
